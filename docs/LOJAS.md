...
Última actualização: 2026-07-23 · **71 lojas · ~169 300 ofertas** no seed
...
Ofertas contadas no seed em 2026-07-23. Horários em UTC; "3×" = três crons
...
| 12 | Farmácia.pt | 4 099 | EAN | sitemap + JSON-LD | ✅ 3× 17h |
...
| 15 | Farmácia Virtual | 3 727 | CNP | WooCommerce (sku=CNP) | ✅ 3× 13h |
| 16 | Skin | 3 688 | CNP (+fp p/ sem-chave) | Magento + **Cloudflare Challenge**: colheita in-page no Browser pane; ProductGroup→variants por tamanho | ❌ **só-browser** (semanal) |
| 17 | Nossa Farmácia | 3 658 | CNP | **VTEX API JSON** (productReference=CNP; paginar por subcategoria) | ✅ 3× 00h45 |
| 18 | Bairro da Saúde | 3 351 | CNP | HTML | ✅ 3× 05h |
| 19 | FastPharma | 2 556 | CNP + EAN | Magento sitemap_web flat (sku=mpn=CNP; gtin13 parcial) | ✅ 3× 01h15 |
| 20 | Dermis | 2 538 | CNP + EAN 81% | API pública api.dermis.pt (Ycommerce=bemecare; campaign_price) | ✅ 3× 06h05 |
| 21 | Love My Pharma | 2 493 | CNP+EAN | Shopify products.json + <handle>.js (barcode) | ✅ 3× 08h55 |
| 22 | FarmaToGo | 2 424 | EAN+CNP | Shopify sitemaps + JSON-LD ficha-a-ficha | ✅ 3× 05h10 |
| 23 | Pharmee | 2 406 | EAN+CNP | sitemap + JSON-LD | ✅ 3× 06h25 |
| 24 | Pharma GDD | 2 401 | EAN | sitemap + JSON-LD | ✅ 3× 22h |
| 25 | Farmácias Progresso | 2 224 | CNP+EAN (sku/mpn flexível) | Presta; sitemap flat sem .html; filtro JSON-LD Product | ✅ 3× 07h40 |
| 26 | CosmeticFan | 2 037 | EAN+CNP | sitemap + JSON-LD | ✅ 3× 05h50 |
| 27 | Unifarma | 2 012 | CNP | Shopify products.json (sku=CNP) | ✅ 3× 03h20 |
| 28 | Easyfarma | 1 985 | CNP | HTML (barcode=CNP) | ✅ 3× 04h |
| 29 | Poupafarma | 1 966 | CNP (+EAN) | Jumpseller ficha-a-ficha (JSON-LD sku) | ✅ 3× 04h10 |
| 30 | Farmácia do Costume | 1 931 | EAN+CNP | sitemap + JSON-LD (mpn=EAN); só fichas .html | ✅ 3× 07h05 |
| 31 | Farmácia Ideal | 1 890 | EAN + CNP | mesma plataforma da Saúde Mayor | ✅ 3× 07h |
...
| 34 | Farmácia Garcia | 1 589 | CNP | loja.farmaciagarcia.net Shopify products.json (sem barcode) | ✅ 3× 09h50 |
| 35 | GO-farma | 1 561 | EAN + CNP | Magento sitemap_products_pt (gtin13 + sku=CNP) | ✅ 3× 03h55 |
| 36 | DocMorris | 1 526 | fingerprint | enrich-only fp+loose+fuzzy; known-only diário + full semanal | ✅ 3× 05h05 + seg 04h30 |
| 37 | Farmácia 365 | 1 415 | EAN | sitemap + JSON-LD; fila ∪ URLs do seed | ✅ 3× 16h |
...
| 41 | byFarma | 1 262 | EAN | Magento + JSON-LD | ✅ 3× 12h |
| 42 | VallisPharma | 1 245 | EAN+CNP | prop Vue :product HTML-encoded | ✅ 3× 03h45 |
| 43 | A Sua Farmácia Online | 1 239 | EAN/CNP | HTML; urlRefreshPass | ✅ 3× 21h |
| 44 | Farmácia Portugal | 1 227 | CNP + EAN parcial | loja. subdomínio; sitemap_web + JSON-LD (sku=mpn=CNP) | ✅ 3× 09h20 |
...
| 52 | Quickfarma | 771 | CNP + EAN | WooCommerce; sitemap AIOSEO com CDATA | ✅ 3× 05h50 |
...
| 57 | Pharma2you | 636 | fingerprint | feed Google Merchant | ✅ 3× 17h |
...
| 60 | ShopCosmetics | 389 | EAN + CNP | PrestaShop 1_index_sitemap CDATA | ✅ 3× 02h30 |
