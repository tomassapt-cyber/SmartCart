...
(async function main() {
  ...
  // [2026-07-30] Removido o cálculo dos "telegram alerts": o elemento que
  // os desenhava (#gm-tg-feed) nunca existiu no HTML, e o Telegram saiu do
  // projeto. Percorria as ofertas todas para produzir 3 linhas invisíveis.
  ...
  const out = {
    ...
    // [2026-07-30] `bestsellers` e `telegram_alerts` DEIXARAM de ser enviados:
    // a secção de bestsellers foi removida do site e o elemento do feed de
    // alertas nunca existiu no HTML. Eram 2,2 KB por visita a não mostrar
    // nada. O CÁLCULO dos bestsellers mantém-se — ele alimenta `usedEans`,
    // que evita os mesmos produtos repetidos nos kits e no "em alta".
