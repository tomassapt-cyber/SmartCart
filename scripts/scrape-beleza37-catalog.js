#!/usr/bin/env node
/**
 * CosMath — catalogo da beleza37.pt (Shopkit, a granel)
 * ============================================================
 ...
 * 7713 produtos no total. Toda a logica esta em lib/shopkit-granel.js,
 ...
 *   node scripts/scrape-beleza37-catalog.js --limit=100    # teste, NAO escreve
 */
...
(async () => {
  ...
  console.log('📦 A buscar o catalogo beleza37.pt a granel (/products.json)…');
  ...
  fs.writeFileSync(OUT_FILE, JSON.stringify({
    ...
    source: 'beleza37.pt (Shopkit /products.json a granel; barcode=EAN, reference=CNP)',
    in_progress: false,
    products: r.produtos,
  }), 'utf8');
