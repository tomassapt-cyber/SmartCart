...
function saveCheckpoint(products, inProgress = true) { fs.writeFileSync(OUT_FILE, JSON.stringify({ scraped_at: new Date().toISOString(), source: 'cocooncenter.pt (parafarmácia FR, storefront PT; JSON-LD gtin13)', in_progress: inProgress, products }), 'utf8'); }
