...
function saveCheckpoint(products, inProgress = true) { fs.writeFileSync(OUT_FILE, JSON.stringify({ scraped_at: new Date().toISOString(), source: 'mycosmetics.pt (Shopify PT; JSON-LD gtin13)', in_progress: inProgress, products }), 'utf8'); }
