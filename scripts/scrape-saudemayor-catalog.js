...
function saveCheckpoint(products, inProgress = true) { fs.writeFileSync(OUT_FILE, JSON.stringify({ scraped_at: new Date().toISOString(), source: 'saudemayor.pt (HTML + regex sobre JSON-LD partido: mpn=EAN, sku=CNP)', in_progress: inProgress, products }), 'utf8'); }
