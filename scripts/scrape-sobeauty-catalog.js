#!/usr/bin/env node
/**
 * CosMath — catalogo da sobeauty.pt (Shopkit, a granel)
 * ============================================================
 ...
 * 954 produtos no total. Toda a logica esta em lib/shopkit-granel.js,
 ...
 *   node scripts/scrape-sobeauty-catalog.js --limit=100    # teste, NAO escreve
 */
...
(async () => {
  ...
  console.log('📦 A buscar o catalogo sobeauty.pt a granel (/products.json)…');
  ...
  fs.writeFileSync(OUT_FILE, JSON.stringify({
    ...
    source: 'sobeauty.pt (Shopkit /products.json a granel; barcode=EAN, reference=CNP)',
    in_progress: false,
    products: r.produtos,
  }), 'utf8');
